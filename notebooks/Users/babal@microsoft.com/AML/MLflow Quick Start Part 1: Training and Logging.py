...
# MAGIC %md 
# MAGIC 1. Ensure you are using or create a cluster specifying Python 3.
# MAGIC 1. If you are running Databricks Runtime, install the required libraries. If you are running Databricks Runtime for Machine Learning, you can skip this step as the required libraries are already installed.
...
# MAGIC 
# MAGIC 1. Click the **Experiment** icon in the notebook context bar to display the Experiment Runs sidebar. In the sidebar, you can view the run parameters and metrics. For example: <img src="https://docs.databricks.com/_static/images/mlflow/mlflow-notebook-experiments-python.gif"/>
# MAGIC    
# MAGIC 1. Click the External Link icon <img src="https://docs.databricks.com/_static/images/external-link.png"/> in the Experiment Runs context bar to view the notebook experiment. For example: <img src="https://docs.databricks.com/_static/images/mlflow/quick-start-nb-experiment.png"/>